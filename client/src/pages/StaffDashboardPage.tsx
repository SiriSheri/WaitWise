      ...
      <div className="bg-white rounded-3xl border border-slate-200/90 p-6 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2.5 w-full md:w-auto">
          ...
          <select
            ...
            className="px-3.5 py-2 rounded-xl border border-slate-300 text-xs font-semibold text-slate-800 bg-white outline-hidden focus:ring-2 focus:ring-indigo-500"
          >
            {allBusinesses.map((b) => (
